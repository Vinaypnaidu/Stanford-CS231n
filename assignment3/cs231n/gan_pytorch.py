...
def discriminator_loss(logits_real, logits_fake):
    ...
    targets_real = torch.ones(logits_real.shape).type(dtype).squeeze()
    targets_fake = torch.zeros(logits_fake.shape).type(dtype).squeeze()
...
def generator_loss(logits_fake):
    ...
    targets_fake = torch.ones(logits_fake.shape).type(dtype).squeeze()
